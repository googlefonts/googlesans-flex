...
def scrub_designspace(designspace: DesignSpaceDocument, project_root: Path) -> None:
    ...
    default_features = designspace.default.font.features.text

    for source in designspace.sources:
        scrub_source(source, skip_export_glyphs, rules, ot_categories, default_features)
...
def scrub_source(
    ...
    scrub_ufo(source.font, skip_export_glyphs, rules, ot_categories, default_features)
...
def scrub_ufo(
    ...
    # Ensure all UFOs have the same feature text.
    ufo.features.text = default_features
